import { Point, geohashFromLatLng, latLngFromGeohash } from './GeoHashLib.js';
...
test('conversion round-tripping works as expected', () => {
    expect(latLngFromGeohash(geohashFromLatLng(-25.38270807825029,-49.265506099909544, 12))).toMatchObject(new Point(-25.38270807825029,-49.265506099909544));
});